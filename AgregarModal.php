    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="AgregarNuevo.php">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label" style="position:relative; top:7px;">Tipo de libro:</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="Tipo de libro">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="Numero de paginas">
					</div>
				</div>
            </div> 
			</div>
